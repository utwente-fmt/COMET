 ...
 * @generated
 */
public class Platform_MetamodelNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					Platform_Metamodel.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof Platform_Metamodel.diagram.navigator.Platform_MetamodelNavigatorItem) {
					selectedElement = ((Platform_Metamodel.diagram.navigator.Platform_MetamodelNavigatorItem) selectedElement)
							.getView();
