 ...
 * @generated
 */
public class Platform_MetamodelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Platform_MetamodelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Platform_Metamodel.diagram.navigator.Platform_MetamodelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Platform_Metamodel.diagram.navigator.Platform_MetamodelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Platform_Metamodel.diagram.navigator.Platform_MetamodelDomainNavigatorItem(
