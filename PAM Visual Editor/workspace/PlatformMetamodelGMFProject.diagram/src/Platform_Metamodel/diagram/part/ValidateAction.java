...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(Platform_Metamodel.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (Platform_Metamodel.diagram.part.Platform_MetamodelDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		Platform_Metamodel.diagram.providers.Platform_MetamodelValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			Platform_Metamodel.diagram.providers.Platform_MetamodelMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		Platform_Metamodel.diagram.part.Platform_MetamodelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new Platform_Metamodel.diagram.part.Platform_MetamodelDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = Platform_Metamodel.diagram.part.Platform_MetamodelDiagramEditorUtil
