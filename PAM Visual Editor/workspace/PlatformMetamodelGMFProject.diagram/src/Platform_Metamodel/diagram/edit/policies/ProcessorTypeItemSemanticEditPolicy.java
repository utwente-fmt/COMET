 ...
 * @generated
 */
public class ProcessorTypeItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ProcessorTypeItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Platform_Metamodel.diagram.part.Platform_MetamodelVisualIDRegistry
					.getVisualID(incomingLink) == Platform_Metamodel.diagram.edit.parts.ProcessorPTypeEditPart.VISUAL_ID) {
