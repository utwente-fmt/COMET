 ...
 * @generated
 */
public class ProcessorTypeIdentifierEditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public ProcessorTypeIdentifierEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ProcessorTypeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProcessorTypeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProcessorTypeLabelFigure() {
			this.setText("ProcessorType");
			this.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000),
