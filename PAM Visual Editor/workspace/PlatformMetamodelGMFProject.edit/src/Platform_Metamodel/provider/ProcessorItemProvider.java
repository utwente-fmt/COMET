...
/**
 * This is the item provider adapter for a {@link Platform_Metamodel.Processor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addVfIslandPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Sensation_Common_MetamodelPackage.Literals.IDENTIFIABLE__IDENTIFIER,
				 true,
				 false,
				 false,
	...
	protected void addInitialStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_initialState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_initialState_feature", "_UI_Processor_type"),
				 Platform_MetamodelPackage.Literals.PROCESSOR__INITIAL_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_pType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_pType_feature", "_UI_Processor_type"),
				 Platform_MetamodelPackage.Literals.PROCESSOR__PTYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Vf Island feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addVfIslandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_vfIsland_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_vfIsland_feature", "_UI_Processor_type"),
				 Platform_MetamodelPackage.Literals.PROCESSOR__VF_ISLAND,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Processor)object).getIdentifier();
